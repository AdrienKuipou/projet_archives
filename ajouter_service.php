...
<body style="background-image:url(se.jpg)">
       <div class="contenaire_body">
           ...
           <legend><strong style="color: white;background-color: rgb(0,0,0);">Ajouter un service</legend></strong>
            <hr style="color:blue"> 
            <?php
               include('enregistrer_ajouter_service.php');
            ?> 
         <div class="container"  >
...
<div class="formulaire">
      <form method="post" action="ajouter_service.php" >
                              ...
                              <div class="dt">
                                         ...
                                         <input type="text" class="form-control" name="nom"  style="width:600px" required/>
                              </div>
                              <br>
                             
                              <div class="dt">
                                         <label for="description">Description:</label><br>
                                         <textarea class="form-control"  name="description"  style="width:600px" cols="15" rows="6"></textarea>
                              </div>
                              <br>
                              <div class="dt">
