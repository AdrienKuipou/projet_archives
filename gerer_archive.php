...
<html>
    <head>
        <title>gérer archive</title>
        <link rel="stylesheet" href="bootstrap.css">
        <link rel="stylesheet" href="style_gerer_archive.css">
      ...
      <div class="main-containerE">
        ...
        <div class="container" >
                <div class="panel panel-info margetop" style=" ">
                  <div class="panel-heading" >Opération sur une archive :</div>
                    <div class="panel-body" >
                   
             <a href="archiver_doc.php" class="btn btn-primary"> Archiver un document </a><br><br>
             <a href="modifier_archive.php" class="btn btn-primary">Modifier </a><br><br>
