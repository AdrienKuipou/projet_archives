...
<html>
    <head>
        ...
        <link rel="stylesheet" href="style_gerer_service.css">
      ...
      <div class="sidebar">
        ...
        <div class="container" >
                <div class="panel panel-info margetop" style=" ">
                  <div class="panel-heading">Opération sur un service :</div>
                    <div class="panel-body" >
                   
             <a href="ajouter_service.php" class="btn btn-primary">Ajouter </a><br><br>
             <a href="modifier_service.php" class="btn btn-primary">Modifier </a><br><br>
