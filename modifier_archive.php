...
<body style="background-image:url(f.jpg)">
   <div class="contenaire_body">
       ...
       <legend><strong style="color: white;background-color: #4CCEE8;">Modifier une archive</strong></legend>   <hr>
      <br>




    <form action="modifier_archive.php" method="post"> 
                              ...
                              <th>Nature du document</th><th>Dossier</th><th>Service</th><th style="width: 10px" >Action</th>
                                          ...
                                          <tbody >
						                   ...
						                   <td ><?php echo $donnees['libelle_service']?></td>
                                                            <td>
				                              <a href="modification_archive.php?id_archive=<?php echo $donnees['id_archive']?>" class="btn btn-primary">
				                                  Modifier
				                              </a>
				                           </td>
                                     ...
                                     <?php while($reponse=$requete->fetch() ){ ?>
                                      <tr class="panel panel-primary" >
						                   ...
						                   <td ><?php echo $reponse['libelle_service']?></td>
                                                            <td>
				                              <a href="modification_archive.php?id_archive=<?php echo $reponse['id_archive']?>" class="btn btn-primary">
				                                  Modifier
				                              </a>
				                           </td>
