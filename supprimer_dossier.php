...
<body  style="background-image:url(do.jpg)">
   <div class="contenaire_body">
       ...
       <legend><strong style="color: white;background-color: rgb(0,0,0);">Supprimer un dossier</legend></strong> <hr>  
      <br><br>
      ...
      <div class="col-sm-9 col-xs-9 header-right">
       ...
       <div class="panel panel-primary"  style="width: 900px" >
            ...
            <div class="panel-heading" style="font-size:1.4em">Listes des dossiers</div>
                        ...
                        <tbody>
                                      ...
                                      <?php while($reponse=$requete->fetch()){ ?>
                                       <tr >
                                           ...
                                           <td>
                                                 <a onclick="return confirm('Etes vous sur de vouloir supprimer ce dossier ?');"  class='btn btn-danger'
                                                    href="enregistrer_supprimer_dossier.php?id_dossier=<?php echo $reponse['id_dossier']?>">
                                                   Supprimer
                                               </a>
                                           </td>
                                       </tr>
