...
<body style="background-image:url(se.jpg)">
   <div class="contenaire_body">
       ...
       <legend><strong style="color: white;background-color: rgb(0,0,0);">Supprimer un service</legend></strong>   <hr>
      <br><br><br>
      
       <div class="panel panel-info"  style="width: 900px" >
  
            <div class="panel-heading" style="font-size:1.4em">Listes des services</div>
                        ...
                        <tbody>
                                      ...
                                      <?php while($reponse=$requete->fetch()){ ?>
                                       <tr >
                                           ...
                                           <td>
                                                 <a onclick="return confirm('Etes vous sur de vouloir supprimer ce service ?');"  class='btn btn-danger'
                                                    href="enregistrer_supprimer_service.php?id_service=<?php echo $reponse['id_service']?>">
                                                   Supprimer
                                               </a>
                                           </td>
                                       </tr>
